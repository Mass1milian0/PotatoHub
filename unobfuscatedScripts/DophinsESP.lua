...
function CreateGUI()
	...
	GTP.Name = "GTP"
	GTP.Parent = Background
	GTP.BackgroundColor3 = Color3.new(0.121569, 0.121569, 0.121569)
	GTP.BackgroundTransparency = 0.5
	GTP.BorderSizePixel = 0
	GTP.Position = UDim2.new(0.5, 5, 0, 90)
	GTP.Size = UDim2.new(0.5, -10, 0, 25)
	GTP.Font = Enum.Font.SourceSansBold
	GTP.Text = "Gun Teleport"
	GTP.TextColor3 = Color3.new(0.815686, 0.815686, 0.815686)
	GTP.TextSize = 16
