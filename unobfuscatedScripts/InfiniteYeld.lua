...
local Dark_5 = Instance.new("Frame")
...
Part.BackgroundColor3 = Color3.new(0.439216, 0.439216, 0.439216)
Part.BorderSizePixel = 0
Part.Position = UDim2.new(0, 5, 0, 150)
Part.Size = UDim2.new(0, 40, 0, 20)
Part.Font = Enum.Font.SourceSans
Part.FontSize = Enum.FontSize.Size14
Part.Text = "Part"
Part.TextColor3 = Color3.new(0, 0, 0)
...
ToPartFrame.BackgroundColor3 = Color3.new(1, 1, 1)
...
background_5.BackgroundColor3 = Color3.new(0.121569, 0.121569, 0.121569)
background_5.BorderSizePixel = 0
background_5.Position = UDim2.new(0, 0, 0, 20)
background_5.Size = UDim2.new(0, 360, 0, 117)

Dark_5.Name = "Dark"
Dark_5.Parent = background_5
Dark_5.Active = true
Dark_5.BackgroundColor3 = Color3.new(0.364706, 0.364706, 0.364706)
Dark_5.BackgroundTransparency = 0.5
Dark_5.BorderSizePixel = 0
Dark_5.Size = UDim2.new(0, 360, 0, 5)

ChoosePart.Name = "ChoosePart"
ChoosePart.Parent = background_5
ChoosePart.BackgroundColor3 = Color3.new(0.364706, 0.364706, 0.364706)
...
ChoosePart.FontSize = Enum.FontSize.Size18
ChoosePart.Text = "Select Part"
ChoosePart.TextColor3 = Color3.new(1, 1, 1)
ChoosePart.TextStrokeTransparency = 0

CopyPath.Name = "CopyPath"
CopyPath.Parent = background_5
CopyPath.BackgroundColor3 = Color3.new(0.364706, 0.364706, 0.364706)
...
CopyPath.FontSize = Enum.FontSize.Size18
CopyPath.Text = "Copy Path"
CopyPath.TextColor3 = Color3.new(1, 1, 1)
CopyPath.TextStrokeTransparency = 0

Directions_4.Name = "Directions"
Directions_4.Parent = background_5
Directions_4.BackgroundColor3 = Color3.new(0.0666667, 0.0666667, 0.0666667)
...
Directions_4.Font = Enum.Font.SourceSansBold
Directions_4.FontSize = Enum.FontSize.Size14
Directions_4.Text = 'Click on a part and then click the "Select Part" button below to set it as a teleport location'
Directions_4.TextColor3 = Color3.new(0.972549, 0.972549, 0.972549)
Directions_4.TextStrokeTransparency = 0
Directions_4.TextWrapped = true
Directions_4.TextYAlignment = Enum.TextYAlignment.Top

Path.Name = "Path"
Path.Parent = background_5
Path.BackgroundColor3 = Color3.new(0.0666667, 0.0666667, 0.0666667)
...
Path.Text = ""
Path.TextColor3 = Color3.new(0.972549, 0.972549, 0.972549)
Path.TextScaled = true
Path.TextStrokeTransparency = 0
Path.TextWrapped = true
Path.TextYAlignment = Enum.TextYAlignment.Top

shadow_5.Name = "shadow"
shadow_5.Parent = ToPartFrame
shadow_5.BackgroundColor3 = Color3.new(0.121569, 0.121569, 0.121569)
shadow_5.BorderColor3 = Color3.new(0, 0, 0)
...
CMDs[#CMDs + 1] = {NAME = 'loopbring [plr] [distance] (CLIENT)', DESC = 'Loop brings a player to you (useful for killing)'}
...
if Players.LocalPlayer.Character ~= nil and Players.LocalPlayer.Character:FindFirstChild('HumanoidRootPart') and Players.LocalPlayer.Character:FindFirstChild('Humanoid') then
	Players.LocalPlayer.Character:FindFirstChildOfClass('Humanoid').Died:connect(function()
		if Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
			lastDeath = Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame
		end
...
addcmd('setwaypointpos',{'setwaypointposition'},
function(args, speaker)
	local WPName = tostring(getstring(1))
	if speaker.Character:findFirstChild("HumanoidRootPart") then
		notify('Modified Waypoints',"Created waypoint: "..getstring(1))
		WayPoints[#WayPoints + 1] = {NAME = WPName, COORD = {args[2], args[3], args[4]}}
	end	
	refreshwaypoints()
	updatesaves()
end)
