...
local IgnorePlayersNamed = {vlader3556=true} -- Name = true or false
--[[
    [J] - To go down the list.
    [U] - To go up the list.
    [H] - To toggle that item in the list.
    [RMB] - To aim at your target using the current settings. (THIS UPDATES IN REAL TIME SO YOU DON'T HAVE TO STOP AIMING FOR IT TO TAKE EFFECT)
--]]
